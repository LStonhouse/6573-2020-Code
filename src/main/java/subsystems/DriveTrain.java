...
AnalogInput frontLeftSteerEncoder = new AnalogInput(0);
addChild("frontLeftSteerEncoder",frontLeftSteerEncoder);
frontLeftSteerEncoder.getVoltage();

AnalogInput frontRightSteerEncoder = new AnalogInput(1);
addChild("frontRightSteerEncoder",frontRightSteerEncoder);
frontRightSteerEncoder.getVoltage();

AnalogInput backLeftSteerEncoder = new AnalogInput(2);
addChild("BackLeftSteerEncoder",backLeftSteerEncoder);
backLeftSteerEncoder.getVoltage();

AnalogInput backRightSteerEncoder = new AnalogInput(3);
addChild("BackRightSteerEncoder",backRightSteerEncoder);
...
backRightSteer.setInverted(false);
    ...
    public void drive(double rotation, double x, double y){
        ...
        double[] getVoltage = new double[4];
        ...
        ticks[3] = backLeftSteerEncoder.get();
        ticks[4] = backRightSteerEncoder.get();

        for(int i = 0; i<4; i++){
            
            currentAngles[i] = ticks[i] /5 *  360;
        }
	...
	public void enable(){
        ...
        frontLeftSteerEncoder.reset();
        frontRightSteerEncoder.reset();
        backLeftSteerEncoder.reset();
        backRightSteerEncoder.reset(); 
	}
